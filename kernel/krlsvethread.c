...
sysstus_t krlsvetabl_retn_threadstats(uint_t inr, stkparame_t *stkparv)
{
    ...
    return krlsve_retn_threadstats((hand_t)stkparv->parmv1, (uint_t)stkparv->parmv2, (uint_t)stkparv->parmv3, (buf_t)stkparv->parmv4);
}
...
sysstus_t krlsvetabl_set_threadstats(uint_t inr, stkparame_t *stkparv)
{
    ...
    return krlsve_set_threadstats((hand_t)stkparv->parmv1, (uint_t)stkparv->parmv2, (uint_t)stkparv->parmv3, (buf_t)stkparv->parmv4);
}
