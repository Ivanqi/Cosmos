 ...
 * 可以被分割成128KB，256KB，512KB，1MB，2MB，4MB，只能分成同一大小的等份，不支持内存共享了，嵌入式os不需要
 */
...
/**
 * 用于挂载同一种大小的mmapdsc队列，比如分割成128KB大小的并对其分类，分配完的、分配一部分的、未分配的
 */
...
/**
 * alcfrelst数组，形成了128KB到4MB大小队列数组 
